...
export default function Details({ params }: Props) {
  ...
  useEffect(() => {
    ...
    if (recruitmentId && applicantId) {
      fetch(`http://ec2-34-199-179-95.compute-1.amazonaws.com:8080/api/v1/recruitment/${recruitmentId}/applicant/${applicantId}`, {
        headers: {
          accept: "*/*",
        },
      })
  ...
  const handleGenerateQuestions = async () => {
    try {
      ...
      const response = await fetch("http://ec2-34-199-179-95.compute-1.amazonaws.com:8080/api/v1/ai-api/"+applicantId+"/question", {
        method: "POST",
        headers: {
          "Accept": "*/*",
